# código em assembly que percorre todo um array pré-definido e exibe o seu conteúdo

.data
	# definindo um array com o conteúdo 100 armazenado em 3 slots de endereço distintos
	myArray: .word 100:4
	newLine: .asciiz "\n"
